...
import { Alert, Box, Button, Card, CardContent, Checkbox, Chip, CircularProgress, Divider, FormControlLabel, MenuItem, Paper, Stack, Step, StepLabel, Stepper, TextField, Typography } from "@mui/material";
...
export function TuitionPaymentWorkspace() {
  ...
  async function submitPayment() {
    ...
    try {
      const response = await fetch("/api/payment-batches", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ tuitionFeeIds: selectedIds, paymentMethod: method, payerName: payerName || undefined, transactionReference: transactionReference || undefined }) });
