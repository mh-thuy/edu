...
export function TuitionList() {
  ...
  function clearFilters() { setStudent(null); setStudentCode(""); setSelectedClass(null); setClassId(""); setStatus(""); setPage(0); }
